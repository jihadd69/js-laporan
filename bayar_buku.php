  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="starter.html"><i class="fa fa-link"></i> <span>Home</span></a></li>
        <li class="active"><a href="data_siswa1.php"><i class="fa fa-link"></i> <span>Data Siswa</span></a></li>
        <li class="active"><a href="datapendaftar.php"><i class="fa fa-link"></i> <span>Pendaftar</span></a></li>
        <li><a href="tambahpendaftar.php"><i class="fa fa-link"></i> <span>Tambah Pendaftar <link rel="stylesheet" type="text/css" href=""></span></a></li>
        <li><a href="data_pembayaran.php".php<i class="fa fa-link"></i> <span>Data Pembayar <link rel="stylesheet" type="text/css" href=""></span></a></li>
        <li><a href="logout.php".php<i class="fa fa-link"></i> <span>Logout <link rel="stylesheet" type="text/css" href=""></span></a></li>
...
$sel = mysqli_query($koneksi, "SELECT * from tb_pembayaran where id_pendaftar = '$id_pendaftar'");
 ...
 ?>
            ...
            <div class="container">
              <h1> Pembayaran Buku</h1>
                ...
                <form class="form-horizontal" role="form" action='function/prosestambahbayar.php' method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Terbayar </label>
              <div class="col-sm-9"><input type="text" id="form-field-1-1" value="<?php echo $bayar; ?>" placeholder="Masukan Nominal" class="col-xs-10 col-sm-5" name="kelas" readonly></div>
               </div>
                ...
                <div class="col-sm-9"><input type="number" id="form-field-1-1" placeholder="Masukan Nominal" class="col-xs-10 col-sm-5" name="terbayar" required="">
                </div>
                </div>
              ...
              <div class="col-sm-9"><input type="text" id="form-field-1-1" value="<?php echo $siswa['kursus']; ?>" placeholder="Masukan Nominal" class="col-xs-10 col-sm-5" name="kelas" readonly></div>
                ...
                <option value="3000000-Reguler">Reguler </option>
                <option value="300000-Toeic">Toeic</option>
                <option value="300000-Toefl">Toefl</option>
                <option value="2500000-course">course</option>/
              </select>
              </h4>
