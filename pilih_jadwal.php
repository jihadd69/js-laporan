  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="starter.html"><i class="fa fa-home"></i> <span>Home</span></a></li>
...
$sel = mysqli_query($koneksi, "SELECT * from tb_jadwal where id_jadwal = '$id_jadwal'");
$row = mysqli_num_rows($sel);
 ...
 ?>
            ...
            <div class="container">
              <h1> Isi Biodata Pendaftar Test</h1>
                ...
                <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Nama Kursus </label>
                <div class="col-sm-9"><input type="text" id="form-field-1-1" value="<?php echo $nama_kursus['nama_kursus'] ?>" placeholder="Nama Lengkap" class="col-xs-10 col-sm-5" name="nama_kursus" readonly>
                </div>
                </div>

                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Hari </label>
              <div class="col-sm-9"><input type="text" id="form-field-1-1" value="<?php echo $siswa; ?>" placeholder="Masukan Nominal" class="col-xs-10 col-sm-5" name="kelas" readonly></div>
               </div>
                ...
                <div class="col-sm-9"><input type="number" id="form-field-1-1" value="<?php echo $jam ['jam'] ?>" placeholder="jam" class="col-xs-10 col-sm-5" name="jam" required="">
                </div>
                </div>
              ...
              <div class="col-sm-9"><input type="text" id="form-field-1-1"  placeholder="Masukan Nominal" class="col-xs-10 col-sm-5" name="kelas" readonly></div>
               </div>
