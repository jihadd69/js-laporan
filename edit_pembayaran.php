 ...
 ?>
            ...
            <div class="container">
              ...
              <div class="col-sm-9"><input type="text" id="form-field-1-1" value="<?php echo $siswa['kursus']; ?>" placeholder="Masukan Nominal" class="col-xs-10 col-sm-5" name="kelas" readonly></div>
                 ...
                 <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Tagihan </label>
              <div class="col-sm-9"><input type="text" id="form-field-1-1" value="<?php echo $siswa['tagihan']; ?>" placeholder="Masukan Nominal" class="col-xs-10 col-sm-5" name="kelas" readonly></div>
               </div>
