  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="data_kelas.php".php<i class="fa fa-file"></i> <span> Data kelas <link rel="stylesheet" type="text/css" href=""></span></a></li><li><a href="data_kelas.php".php<i class="fa fa-file"></i> <span> Data kelas <link rel="stylesheet" type="text/css" href=""></span></a></li>
      ...
      <!--------------------------
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="container">
              <h1> Tambah Jadwal Test</h1>
              

                <form class="form-horizontal" role="form" action='function/proses_tambahjadwal.php' method="post" enctype="multipart/form-data">
                ...
                <div class="col-sm-9"><input type="tel" id="form-field-1-1" placeholder="Masukan Jenis Kursus" class="col-xs-10 col-sm-5" name="nama_kursus" required="">
                </div>
                </div>
                ...
                <div class="col-sm-9"><input type="text" id="form-field-1-1" placeholder="Masukan Hari " class="col-xs-10 col-sm-5" name="hari" required="">
                </div>
                </div>

                <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Jam </label>
                <div class="col-sm-9"><input type="time" id="form-field-1-1" placeholder="Masukan jam kursus " class="col-xs-10 col-sm-5" name="jam"required="">
                </div>
                </div>
