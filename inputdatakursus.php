          ...
          <div class="box">
            ...
            <div class="container">
              <h1> Isi Input Data Kelas</h1>
                ...
                <form class="form-horizontal" role="form" action='function/proses_tambahkelas.php' method="post" enctype="multipart/form-data">
                ...
                <h4><select name="nama_kursus">
                  <option value="1">Pilih Kursus</option>
                <option value="English For Conversation">English For Conversation </option>
                <option value="English for Gramer">English for Gramer </option>
                ...
                <option value="Elementary 1">English For Conversation </option>
                <option value="Elementary 2">English for Gramer </option>
                <option value="Elementary 3">English For Business</option>
                <option value= "Intermadiet"> Intermadiet </option>
                <option value="Advance">Advancec</option>/
              </select>
              </h4>
                </div>
                ...
                <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Quota </label>
                <div class="col-sm-6"><input type="number" id="form-field-1-1" placeholder="masukkan jumlah quota" class="col-xs-10 col-sm-5" name="quota"required="">
                </div>
                </div>
