          ...
          <div class="box">
            ...
            <div class="container">
              <h1> Isi Biodata Dengan Lengkap</h1>
                ...
                <form class="form-horizontal" role="form" action='function/prosestambah.php' method="post" enctype="multipart/form-data">
                ...
                <div class="col-sm-9"><input type="number" id="form-field-1-1" placeholder="Nomor Telfon Yang Aktif" class="col-xs-10 col-sm-5" name="nomor_telfon" required="">
                </div>
                </div>

                <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Email</label>
                <div class="col-sm-9"><input type="email" id="form-field-1-1" placeholder="Email Yang Aktif" class="col-xs-10 col-sm-5" name="email" required="">
                </div>
                </div>

                <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Umur </label>
                <div class="col-sm-9"><input type="number" id="form-field-1-1" placeholder="Umur" class="col-xs-10 col-sm-5" name="umur" required="">
                </div>
                </div>
