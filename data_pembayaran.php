  ...
  <div class="content-wrapper">
      ...
      <!--------------------------
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="table-responsive no-padding">
              <table class="table table-hover table-bordered" width="100%">
                <a href='laporan.keuangan.php?' type='button' 
            class='btn btn-default' style='color:white;background-color:Mediumseagreen;padding:4px'><span class='glyphicon glyphicon-print'></span> Cetak Pembayaran</a>
    ...
    <tbody>
        ...
        while($siswa = mysqli_fetch_array($query))
        {
            ...
            echo "<tr>";
            echo "<td>".$no."</td>";
            echo "<td>".$siswa['id_pendaftar']."</td>";
            echo "<td>".$siswa['nama_lengkap']."</td>";
            echo "<td>".$siswa['tanggal']."<?td>";
            echo "<td <b> Rp. ".number_format($siswa['bayar'],0,",",".")."</b></td>";
            echo "<td>";

            echo "<a href='edit_pembayaran.php?id_pendaftar=$siswa[id_pendaftar]' type='button' 
            class='btn btn-default' style='color:white;background-color:Mediumseagreen;padding:4px'><span class='glyphicon glyphicon-edit'></span> Bayar Pendaftaran</a>
            ";
    ...
    <tfoot>
      <tr>
        <td colspan="1"><p>Total: <?php echo mysqli_num_rows($query) ?></p></td>
      </tr>
