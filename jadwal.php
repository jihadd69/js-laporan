      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li class="active"><a href="starter.html"><i class="fa fa-home"></i> <span>Home</span></a></li>
        ...
        <li><a href="data_pembayaran.php".php<i class="fa fa-file"></i> <span>Data Pembayaran Buku <link rel="stylesheet" type="text/css" href=""></span></a></li>
         <li><a href="data_kelas.php".php<i class="fa fa-file"></i> <span>Data Kelas <link rel="stylesheet" type="text/css" href=""></span></a></li>
          <li><a href="data_kelas.php".php<i class="fa fa-file"></i> <span>Jadwal Test <link rel="stylesheet" type="text/css" href=""></span></a></li>
          ...
          <div class="box">
            ...
            <div class="table-responsive no-padding">
              <table class="table table-hover table-bordered" width="100%">
                ...
                <a href='tambah_jadwal.php? type='button' 
            class='btn btn-default' style='color:white;background-color:Mediumseagreen;padding:4px'><span class='glyphicon glyphicon-plus'></span> Tambah Kelas</a>
    <thead>
        <tr>
            <th>No</th>
            <th>Nama Kursus</th>
    ...
    <tbody>
        ...
        while($siswa = mysqli_fetch_array($query))
        {
          ...
          $num = mysqli_num_rows($data);
            ...
            echo "<a href='pilih_jadwal.php?id_jadwal=$siswa[id_jadwal]' ' type='button' 
            class='btn btn-default' style='color:white;background-color:Mediumseagreen;padding:4px'><span class='glyphicon glyphicon-usd'></span> Daftar</a>
            ";
            if ($num > 0) 
